  ...
  return (
    ...
    >
      <div className="modal-box">
        <h1 className="font-bold text-2xl mb-4">Ooops!</h1>
        <h2 className="text-accent text-center mb-8">
          Are you sure you want to delete this task?
        </h2>
        <div className="gap-4 flex justify-end">
          <button className="btn btn-success" onClick={deleteConfirmHandler}>
            Yes
          </button>
          <button className="btn btn-error" onClick={deleteCancelHandler}>
            Cancel
          </button>
        </div>
      </div>
